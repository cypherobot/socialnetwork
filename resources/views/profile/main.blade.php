...
<head>
    ...
    <title> Social Evoke | Profile Main</title>
    ...
    <style>
        .profile-menu .button.is-active {
            ...
            box-shadow: 0 14px 26px -12px rgba(255, 255, 255, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(255, 255, 255, 0.2) !important
        }
                                ...
                                <div class="card is-post">
                                    ...
                                    <div class="content-wrap">
                                        ...
                                        <div class="card-body">
                                            <!-- Post body text -->
                                            <div class="post-text">
                                                <p>Today i visited this amazing little fashion store in Church street. Everything is handmade, from skirts to bags. Their products really have an outstanding quality. If you don't know them already, well it's
                                ...
                                <div class="card is-post has-nested">
                                    ...
                                    <div class="content-wrap">
                                        ...
                                        <div class="card-body">
                                            <!-- Post body text -->
                                            <div class="post-text">
                                                <p>My brother went to their concert last night, and looks like he had tons of fun. We should really do things like this together.
                                                    <p>
                                            </div>
                                            <!-- Featured image -->
                                ...
                                <div class="card is-post">
                                    ...
                                    <div class="content-wrap">
                                        ...
                                        <div class="card-body">
                                            <!-- Post body text -->
                                            <div class="post-text">
                                                <p>Hello everyone! Today iam posting a review of the latest shoe trends. I tried for you more than 30 pairs of shoes. I had some crushes and some deceptions, However, it was a great experience i would like
                                                    to share with you.
                                                    <p>
                                            </div>
                                            <!-- Featured image -->
                                    ...
                                    <div class="comments-wrap is-hidden">
                                        ...
                                        <div class="card-footer">
                                            <div class="media post-comment">
                                                ...
                                                <div class="media-left">
                                                    <p class="image is-48x48">
                                                        <img src="https://via.placeholder.com/300x300" data-demo-src="assets/img/avatars/jenna.png" data-user-popover="8" alt="">
                                                    </p>
                                                </div>
                                                <!-- Textarea -->
                                                <div class="media-content">
                                    ...
                                    <div class="comments-wrap is-hidden">
                                        ...
                                        <div class="card-footer">
                                            <div class="media post-comment">
                                                ...
                                                <div class="media-left">
                                                    <p class="image is-48x48">
                                                        <img src="https://via.placeholder.com/300x300" data-demo-src="assets/img/avatars/jenna.png" data-user-popover="4" alt=""> data-user-popover="8" alt="">
                                                    </p>
                                                </div>
                                                <!-- Textarea -->
                                                <div class="media-content">
